...
const initialDictionary_json_1 = __importDefault(require("../../core/src/dictionary/initialDictionary.json"));
const templates_1 = require("../../core/src/emergency/templates");
...
async function main() {
    ...
    let catCount = 0;
    for (const cat of initialDictionary_json_1.default.categories) {
    ...
    for (const [key, data] of Object.entries(templates_1.EMERGENCY_TEMPLATES)) {
