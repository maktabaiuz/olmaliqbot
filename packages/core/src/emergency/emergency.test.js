...
describe('Emergency Response Engine (Favqulodda Shablonlar)', () => {
    it('should render Level 1 gas leak safety instructions in Uzbek Latin', () => {
        const output = (0, render_1.renderEmergencyTemplate)('gas_leak', 'lotin', { mahalliy_gaz: '+998 70 612 34 56' });
    ...
    it('should render Level 1 in Russian correctly', () => {
        const output = (0, render_1.renderEmergencyTemplate)('gas_leak', 'rus', { mahalliy_gaz: '901234567' });
    ...
    it('should strip missing local numbers completely without artifacts', () => {
        const output = (0, render_1.renderEmergencyTemplate)('gas_leak', 'lotin', {}); // No local number
    ...
    it('should render Level 2 water pipe with plumber list after official service', () => {
        const output = (0, render_1.renderEmergencyTemplate)('water_pipe', 'lotin', { mahalliy_suv: '+998 70 615 00 00' }, 'Bahrom ✅ ⭐4.4 — +998 90 123 45 67');
...
//# sourceMappingURL=emergency.test.js.map