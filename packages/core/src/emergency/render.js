...
exports.renderEmergencyTemplate = renderEmergencyTemplate;
const templates_1 = require("./templates");
function renderEmergencyTemplate(category, lang = 'lotin', localNumbers = {}, serviceListingsFormatted) {
    const data = templates_1.EMERGENCY_TEMPLATES[category];
    if (!data)
        return null;
