  ...
  return (
    <div className="flex flex-col gap-4 animate-fade-in pb-10">
      ...
      <div className="flex items-center gap-3 border-b border-outline-variant/30 pb-3">
        <button
          onClick={() => {
            if (activeSection === 'menu') onBackToDashboard();
      ...
      {/* SECTION 2: SHAHARLAR LIST */}
      {activeSection === 'cities' && (
        <div className="space-y-3">
          {cities.map((city) => (
            <div
              key={city.id}
              className="bg-surface dark:bg-[#17212B] p-4 rounded-2xl border border-outline-variant/30 dark:border-slate-800 shadow-sm space-y-2 relative overflow-hidden"
            >
              <div
