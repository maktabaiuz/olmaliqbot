...
export const SuperAdminControlScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 pb-24 animate-fade-in max-w-container-max mx-auto">
      ...
      <section className="bg-gold-grad text-white rounded-card p-5 shadow-fab flex flex-col gap-2 relative overflow-hidden">
      ...
      <section className="grid grid-cols-3 gap-2.5">
        <div className="bg-white dark:bg-[#16212F] p-3.5 rounded-card border border-ios-sep/60 dark:border-ios-darkSeparator flex flex-col gap-1 shadow-card">
          <span className="text-[11px] font-semibold text-ios-gray">Shaharlar</span>
        ...
        <div className="bg-white dark:bg-[#16212F] p-3.5 rounded-card border border-ios-sep/60 dark:border-ios-darkSeparator flex flex-col gap-1 shadow-card">
          <span className="text-[11px] font-semibold text-ios-gray">Daromad</span>
        ...
        <div className="bg-white dark:bg-[#16212F] p-3.5 rounded-card border border-ios-sep/60 dark:border-ios-darkSeparator flex flex-col gap-1 shadow-card">
          <span className="text-[11px] font-semibold text-ios-gray">Arizalar</span>
          <span className="text-[20px] font-extrabold text-gold">
            {stats.pendingApplications}
          </span>
          <span className="text-[10px] text-gold font-bold">kutilmoqda</span>
        </div>
      </section>
