  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col items-center justify-center p-6 font-sans">
      <div className="bg-slate-800/90 border border-slate-700/80 rounded-2xl p-8 max-w-sm w-full shadow-2xl backdrop-blur-md">
        <div className="w-14 h-14 bg-brand-500/10 border border-brand-500/30 rounded-2xl flex items-center justify-center mx-auto mb-5 text-brand-400 text-2xl">
          🔑
        </div>
        ...
        <p className="text-slate-400 text-xs mb-6 text-center">
          Boshqaruv paneliga kirish uchun parolingizni kiriting
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-brand-600 hover:bg-brand-500 active:bg-brand-700 text-white font-semibold py-3 px-4 rounded-xl text-sm transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
